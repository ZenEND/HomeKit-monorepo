...
const MunchkinGame = lazy(() => import('./pages/munchkin/Game'));
const MunchkinSpectator = lazy(() => import('./pages/munchkin/Spectator'));
...
export const router = createBrowserRouter([
  ...
  {
    path: '/munchkin/spectator/:code',
    element: <MunchkinSpectator />,
    errorElement: <RouteErrorElement />,
  },
  {
    path: '/',
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'munchkin',
            element: <MunchkinLobby />,
          },
          {
            path: 'munchkin/game/:roomId',
            element: <MunchkinGame />,
          },
          {
            path: 'roadmap',
            element: <Roadmap />,
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'admin/monitor',
            element: <GameMonitorPage />,
          },
          {
            path: 'admin/door-events',
            element: <DoorEventCreatorPage />,
          },
        ],
      },
      {
